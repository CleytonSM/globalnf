...
function DonateHeroSection() {
  return (
    <section className="bg-brand py-40 px-6 text-center">
      <div className="max-w-3xl mx-auto">
        <motion.span
          className="inline-block text-xs font-semibold uppercase tracking-widest text-white/50 mb-6"
          {...stagger(0.1)}
        >
          Donate
        </motion.span>
          ...
          <FadeIn>
            <div>
              ...
              <div className="space-y-5 text-dark/70 leading-relaxed mb-8">
                ...
                <p>Your gift is tax-deductible to the fullest extent of the law.</p>
              </div>
          ...
          <FadeIn delay={0.15}>
            <div className="bg-neutral rounded-2xl p-8">
              ...
              >
                ...
                {/* Preset amounts */}
                <div>
                  <label className="block text-sm font-medium text-dark mb-2">Select amount</label>
    ...
    <section className="py-20 bg-neutral">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { percent: '60%', label: 'Programs & Services', desc: 'Directly funding nurse support, community tools, and educational resources.', color: 'bg-brand' },
            { percent: '25%', label: 'In-Country Grants', desc: 'Education grants for nursing students in low-income countries globally.', color: 'bg-green' },
            { percent: '15%', label: 'Operations', desc: 'Technology infrastructure, compliance, and organizational sustainability.', color: 'bg-navy' },
          ].map(({ percent, label, desc, color }, i) => (
